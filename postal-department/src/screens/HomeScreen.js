    ...
    <View style={styles.container}>
      <View style={styles.content}>
        <View style={styles.gridContainer}>
          ...
          >
            <FontAwesome5 name="envelope" size={24} color="#9C1D1D" />
            <Text style={styles.gridText}>SLP Mail</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.gridItem} onPress={() => {}}>
            <FontAwesome5 name="desktop" size={24} color="#9C1D1D" />
            <Text style={styles.gridText}>E Counter</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.gridItem} onPress={() => {}}>
            <FontAwesome5 name="building" size={24} color="#9C1D1D" />
            <Text style={styles.gridText}>Branch Management</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.gridItem} onPress={() => {}}>
            <FontAwesome5 name="users" size={24} color="#9C1D1D" />
          ...
          <TouchableOpacity style={styles.gridItem} onPress={() => {}}>
            <FontAwesome5 name="cogs" size={24} color="#9C1D1D" />
          ...
          >
            <FontAwesome5 name="wrench" size={24} color="#9C1D1D" />
